const products = {
  product2: {
    ...
    options: [{ weight: "500ml", price: 145.00 }],
    basePrice: 145,
    weight: "500ml",
    img: "images/p2.png",
  ...
  product3: {
    name: "Cold Pressed Groundnut Oil ",
    options: [{ weight: "1 l", price: 290.00 }],
    basePrice: 290,
    weight: "1l",
    img: "images/p3.png",
  ...
  product4: {
    ...
    options: [{ weight: "500ml", price: 220.00 }],
    basePrice: 220,
    weight: "500ml",
    img: "images/p4.png",
  ...
  product5: {
    name: "Cold Pressed Gingely Oil",
    options: [{ weight: "1l", price: 440.00 }],
    basePrice: 440,
    weight: "1l",
    img: "images/p5.png",
  ...
  product6: {
    ...
    options: [{ weight: "500ml", price: 210.00 }],
    basePrice: 210,
    weight: "500ml",
    img: "images/p6.png",
  ...
  product7: {
    name: "Cold Pressed Coconut Oil",
    options: [{ weight: "1l", price: 420.00 }],
    basePrice: 420,
    weight: "1l",
    img: "images/p7.png",
  ...
  karupu_rice: {
    name: "Karuppu Kavuni Porridge",
    options: [
        { weight: "250g", price: 99.00 },
        { weight: "500g", price: 198.00 },
    ],
    basePrice: 99,
    weight: "250g / 500g",
    img: "images/karupurice-1.jpeg",
    desc: "Karuppu Kavuni rice is rich in antioxidants, which help fight free radicals and slow aging. It supports heart health by lowering cholesterol and improving blood circulation. Regular consumption aids digestion, boosts energy, and helps maintain healthy skin and hair.",
  ...
  product11: {
    ...
    options: [
        { weight: "250g", price: 80.00 },
        { weight: "500g", price: 160.00 },
    ],
    basePrice: 80,
    weight: "250g / 500g",
  ...
  product15: {
    ...
    options: [
        { weight: "250g", price: 90.00 },
        { weight: "500g", price: 180.00 },
    ],
    basePrice: 90,
    weight: "250g / 500g",
  ...
  product19: {
    ...
    options: [
        { weight: "250g", price: 70.00 },
        { weight: "500g", price: 140.00 },
    ],
    basePrice: 70,
    weight: "250g / 500kg",
    img: "images/p19.png",
  ...
  product21: {
    ...
    options: [{ weight: "225g", price: 99.00 }],
    basePrice: 99,
    weight: "225g",
    img: "images/p21.png",
